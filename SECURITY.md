...
Do not open a public GitHub issue for a security problem. Include enough detail to reproduce the issue, the affected URL or component, and any relevant request/response samples with secrets removed.
